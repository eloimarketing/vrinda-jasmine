...
async function getProductsByCategory(category: string, subcategory?: string, search?: string) {
...
export default async function CategoryPage({ params, searchParams }: CategoryPageProps) {
  ...
  const { subcategory, search } = await searchParams;
  
  const products = await getProductsByCategory(category, subcategory, search);

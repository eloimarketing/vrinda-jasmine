...
import { commonInfoSchema, independentHouseVillaSchema } from '@/lib/schema/backend/property'
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="Enter latitude" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="Enter longitude" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="e.g., 2, 3" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} />
										</FormControl>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input placeholder="20000" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
